...
class AmericanPizzaFactoryTest {
    ...
    void shouldPrepareCorrectPizza(){
        ...
        assertEquals("Margeritta na grubym cieście" , ret.getFullName());
        ...
        assertEquals("Marinara na grubym cieście" , ret.getFullName());
        ...
        assertEquals("Napoleońska na grubym cieście" , ret.getFullName());
        ...
        assertEquals("Hawajska na grubym cieście" , ret.getFullName());
        ...
        assertEquals("Funghi na grubym cieście" , ret.getFullName());
        ...
        assertEquals("Quatro na grubym cieście" , ret.getFullName());
        ...
        assertEquals("Capricciosa na grubym cieście" , ret.getFullName());
        ...
        assertEquals("Dynamit na grubym cieście" , ret.getFullName());
